...
import { isForeignKeyError } from "../../database/database-error.js";
...
import type { AssetInventory } from "../assets/inventory/commands.js";
import type {
  CreateFindingRecord,
  FindingRecord,
  UpdateFindingRecord,
...
export function createFindingsBehavior({
  database,
  findingProjection,
  findingPersistence,
