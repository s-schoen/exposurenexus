...
describe("findings cross-feature persistence", () => {
  ...
  function createCapability() {
    const runtime = createBackendRuntime({ database: testDb.db, logger });
    return {
      findings: createFindings(runtime),
      vulnerabilities: createVulnerabilities(runtime),
      statistics: createStatistics(runtime),
    };
  }
