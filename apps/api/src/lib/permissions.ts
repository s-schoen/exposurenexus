...
export type DomainPermissionPayload<Resource extends PermissionResource = PermissionResource> =
  ResourcePermissionVerbAssignment & Partial<Record<Resource, readonly PermissionVerb[]>>;
