...
export type CreateDomainEventPayloadInput<TSubject extends EventSubject> = Omit<
  ...
  "id" | "time"
> &
  Partial<Pick<DomainEventPayloadBase<TSubject, EventPayloads[TSubject]>, "id" | "time">>;
...
export function createDomainEventEmitter<TSubject extends EventSubject = EventSubject>(
