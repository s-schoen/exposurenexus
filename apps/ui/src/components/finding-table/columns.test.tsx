...
async function createColumns(
  ...
  const { createFindingColumns } = await import("@/components/finding-table/columns.tsx");
...
describe("createFindingColumns", () => {
  ...
  it("formats due dates without shifting the UTC date key", async () => {
    const { formatFindingDueDate } = await import("@/components/finding-table/columns.tsx");
  ...
  it("only treats active and confirmed findings with past due dates as overdue", async () => {
    const { isFindingOverdue } = await import("@/components/finding-table/columns.tsx");
