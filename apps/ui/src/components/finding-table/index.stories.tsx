...
import type { Finding, UpdateFinding } from "@openvlp/types/model/finding"
...
function FindingTableStoryShell({
  findings,
  assets,
  users,
  scenario
}: FindingTableStoryArgs) {
  ...
  useLayoutEffect(() => {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      if (findingId) {
        ...
        if (method === "DELETE") {
          findingsRef.current = findingsRef.current.filter(
