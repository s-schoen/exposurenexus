...
describe("DataTable stories", () => {
  it("renders the default table state", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByPlaceholderText("Search across visible columns")).toBeTruthy()
  ...
  it("marks the active row", async () => {
    ...
    await waitFor(() => {
      ...
      expect(within(activeRow as HTMLTableRowElement).getByText("Missing MFA enforcement for staging")).toBeTruthy()
    })
  })
