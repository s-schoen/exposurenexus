...
vi.mock("@/features/findings/components/finding-table/context-menu.tsx", () => ({
  FindingContextMenu: ({
    children,
    findings,
    onDelete,
...
describe("FindingTable workflow wiring", () => {
  ...
  it("passes query-state filters and row handlers to DataTable", async () => {
    const { FindingTable } = await import("@/features/findings/components/finding-table/index.tsx");
