...
export function UserDetailContent({ user: userData, roles, titleAction }: UserDetailContentProps) {
  ...
  function renderRoleBadges(compact = false) {
        ...
        <CardHeader className="gap-4">
          ...
          <div className="space-y-3">
            <div className="space-y-2">
              <CardTitle className="text-2xl font-semibold tracking-tight">{displayName}</CardTitle>
    ...
    return (
      <MetadataSidebar title="User details" icon={UserIcon}>
        <div className="space-y-3">
          ...
          <MetadataDetailRow label="Roles" value={renderRoleBadges(true)} />
        </div>
      </MetadataSidebar>
    );
  }
