...
import { CustomFieldPreview } from "@/features/custom-fields/components/custom-field-preview.tsx";
...
function CustomFieldPreviewStoryShell({
  customFieldId,
  customField,
  scenario,
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="w-full max-w-6xl">
        <CustomFieldPreview customFieldId={customFieldId} />
      </div>
    </QueryClientProvider>
  );
}
...
const meta = {
  ...
  component: CustomFieldPreviewStoryShell,
  parameters: {
    layout: "padded",
  },
  args: {
  ...
  render: (args) => <CustomFieldPreviewStoryShell {...args} />,
} satisfies Meta<typeof CustomFieldPreviewStoryShell>;
