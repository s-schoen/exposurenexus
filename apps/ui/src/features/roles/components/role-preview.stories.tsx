...
import { RolePreview } from "@/features/roles/components/role-preview";
...
function RolePreviewStoryShell({ roleId, role, scenario }: RoleDetailStoryArgs) {
...
const meta = {
  title: "Resources/Roles/Preview",
  component: RolePreviewStoryShell,
  parameters: {
    layout: "padded",
  },
  args: {
  ...
  render: (args) => <RolePreviewStoryShell {...args} />,
} satisfies Meta<typeof RolePreviewStoryShell>;
